...
class ObserVationHolder(val binding :ItemCriticalPatientListBinding) : RecyclerView.ViewHolder(binding.root) {
...
class ObaserVationsAdapter(private var mObservations: List<DashboardObservationsResponse>,
                    private val itemClickListener: OnItemClickListener, private var mContext:Context) : RecyclerView.Adapter<ObserVationHolder>() {
