...
class SetBaseUrlViewModel(application: Application) : AndroidViewModel(Application()) {
    ...
    private var mLoginRepository: SetBaseUrlRepository =
        SetBaseUrlRepository()
    ...
    fun isValidEmail(email: String): Boolean{
        return  email.trim().isNullOrBlank()
